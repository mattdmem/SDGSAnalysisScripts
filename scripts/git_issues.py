...
for i in gh.get_repo(60533960).get_issues(state="closed"):
    labels = []
    ...
    print '<tr>'
    print '<td>' + i.title + '</td>'
    print '<td>' + ",".join(labels) + '</td>'
    print '<td>' + i.user.login + '</td>'
    if i.assignee is not None:
        print '<td>' + i.assignee.login + '</td>'
    else:
        print '<td>No Assignee</td>'
    print '<td>' + str(int(total.total_seconds() / float(86400))) + "</td>"
    print '</tr><tr>'
    if i.body != "":
        print '<td colspan="5">'+i.body+'</td>'
    else:
        print '<td colspan="5">No Description</td>'
    print '</tr>'
...
#print gh.get_repo(60533960).created_at
...
#         print i.title
#         print i.body
#         print total.total_seconds() / float(86400)
#         print "---------------"

# count_total=0
# count_body=0
# for i in gh.get_repo(60533960).get_issues(state="open"):
#     if i.body == "":
#         count_body+=1
#     count_total+=1
#
...
#
# for i in gh.get_user().get_issues(state="closed"):
#     print i

# for i in gh.repos.list().all():
#     print i
